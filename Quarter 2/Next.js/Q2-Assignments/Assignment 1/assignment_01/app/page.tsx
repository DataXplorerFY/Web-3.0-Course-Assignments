  ...
  return (
    ...
    <main>
      ...
      <div className="main" >
        ...
        <iframe src="https://www.youtube.com/embed/8irDnbntlTo?si=hYCgV-2wHvZDTOng" width={930} height={540} ></iframe>

        <p > <h2>The Future of the Web is Web 3.0, Metaverse, and Edge Computing.Panaverse DAO is a movement to spread these technolgies globally. It is community of Web 3 and Metaverse developers, designers, trainers, startup founders and service providers.</h2> </p>
        ...
        <p>
          ...
          <h2>Next.js 13 using TailwindCSS (Remote Zoom Class)</h2>
          ...
          <h2>AWS Application Composer (Remote Zoom Class)</h2>
          ...
          <h2>Multi-Cloud GraphQL Serverless API Development with Cloud Development Kit for Terraform (CDKTF) (Remote Zoom Class)</h2>
          ...
          <h2>Build Full-Stack Next.js 13 Jamstack Templates</h2>
          ...
          <h3>W3-351: Developing Smart Contracts and Planet-Scale Web 3.0 Dapps</h3>
          ...
          <h2>Blockchain and Metaverse Theory</h2>
          ...
          <h2>MV-361: Developing Planet-Scale Open Virtual and Augmented Metaverse Experiences</h2>
          Duration: 13 Weeks
          <br />
          <br />
          Course Description:
